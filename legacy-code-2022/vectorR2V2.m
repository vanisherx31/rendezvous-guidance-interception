 function [bv5 bv7 bv6 Mx1 Mn1 ]=vector(px,py,time); %(bv5 = first position; bv6 = vector coordinate; bv7 = immidiate next position  )
% clear all; clc ; clf;
...
%         px(i) = a1011((k),1) - i;
%         py(i) = a1011((k),2) - i;
          px(i) = randi([0 500],1,1);
          py(i) = randi([0 500],1,1);
    else 
    end
